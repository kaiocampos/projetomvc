    ...
    <nav class="navbar navbar-expand-lg navbar-light ">
      ...
      <div class="collapse navbar-collapse  catnav " id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo BASEURL; ?>#"><i class="fas fa-gamepad"></i> Brinquedos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo BASEURL; ?>#"><i class="fas fa-sticky-note"></i> Adesivos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo BASEURL; ?>#"><i class="fas fa-laptop-code"></i>
              Informatica</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo BASEURL; ?>#"><i class="fas fa-sticky-note"></i> Acessorios</a>
          </li>
